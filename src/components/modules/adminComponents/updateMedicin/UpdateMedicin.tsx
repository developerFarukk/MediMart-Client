...
//     //         const res = await updateMedicin({ id: medicin?._id, data });
//     //         console.log(res);
...
//         if (!medicin?._id) {
//             toast.error("Invalid medicin ID", { id: toastId });
//             return;
//         }

//         let imageUrl = medicin?.mediImage; // Default to existing image URL
...
//             const res = await updateMedicin({ data: updatedData, medicinId: medicin?._id });
//             console.log(res);
