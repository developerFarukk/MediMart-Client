...
//                                     <th className="px-4 py-2 font-medium whitespace-nowrap">
//                                         <ToolTipePage title="P. Status" tole="Payment Status" />
//                                     </th>
//                                     <th className="px-4 py-2 font-medium whitespace-nowrap">
//                                         <ToolTipePage title="S. Address" tole="Shipping Address" />
//                                     </th>
//                                     <th className="px-4 py-2 font-medium whitespace-nowrap">
//                                         <ToolTipePage title="P. Method" tole="Payment Method" />
//                                     </th>
//                                     <th className="px-4 py-2 font-medium whitespace-nowrap text-gray-900">Status</th>
//                                     <th className="px-4 py-2 font-medium whitespace-nowrap text-gray-900">City</th>
//                                     <th className="px-4 py-2 font-medium whitespace-nowrap text-gray-900">Tranjection ID</th>
//                                     <th className="px-4 py-2 font-medium whitespace-nowrap text-gray-900">Total Quantity</th>
//                                     <th className="px-4 py-2 font-medium whitespace-nowrap text-gray-900">Total Price</th>
...
const AllOrdersByAdmin = ({ orders }: TOrderAdmin) => {
    ...
    //                 const { data: newMedicins } = await getAllMedicins(currentPage, 10);
    //                 if (newMedicins) {
    //                     setOrder(newMedicins.result);
    //                     setTotalOrder(newMedicins.meta.total);
    //                     setTotalPage(newMedicins.meta.totalPage);
    //                 }
                                    ...
                                    order.map((order: TOrder, index: number) => {
                                        ...
                                        return (
                                            <tr key={order?._id}>
                                                ...
                                                <td className="px-4 py-2 whitespace-nowrap text-gray-700">{order?.shippingAddress}</td>
                                                <td className="px-4 py-2 whitespace-nowrap text-gray-700">{order?.paymentMethod}</td>
                                                <td className="px-4 py-2 whitespace-nowrap text-gray-700">{order?.status}</td>
                                                <td className="px-4 py-2 whitespace-nowrap text-gray-700">{order?.city}</td>
                                                <td className="px-4 py-2 whitespace-nowrap text-gray-700">{order?.transaction?.id || "N/A"}</td>
                                                <td className="px-4 py-2 whitespace-nowrap text-gray-700">{order?.totalQuantity}</td>
                                                <td className="px-4 py-2 whitespace-nowrap text-gray-700">{order?.totalPrice}</td>
                                                <td className="flex justify-center gap-4 px-4 py-2 whitespace-nowrap text-gray-700">
                                                    <div className="text-blue-500 hover:underline" title="Update">
                                                        {/* <UpdateMedicin title={<Pencil />} medicin={order} /> */}
                                                    </div>
                                                    <button
                                                        // onClick={() => handleDeleteMedicin(order)}
                                                        className="text-blue-500 hover:underline" title="Delete">
                                                        <Trash2 />
                                                    </button>
                                                </td>
