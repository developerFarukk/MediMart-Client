            ...
            <div className='group'>
                            ...
                            <div className='flex gap-8 '>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <div className='mt-5 flex items-center font-medium transition-all duration-500 ease-out'>
                                        ...
                                        <button onClick={() => addToWishList(id)} className='z-10 rounded-[4px] bg-black px-6 py-[10px] text-white shadow-2xl duration-500 hover:bg-[#DF2626] hover:text-white hover:shadow-lg'>
                                            Add To Wishlist
                                        </button>
                                        <button onClick={() => compareShoes(shoe)} className='z-10 rounded-[4px] bg-black px-6 py-[10px] ml-12 text-white shadow-2xl duration-500 hover:bg-[#DF2626] hover:text-white hover:shadow-lg'>
                                            Compare
                                        </button>
                                    </div>
                                </div>
                ...
                <div className='mt-6'>
                    ...
                    <div className='mt-2 flex items-end gap-1'>
                        ...
                        {/* <p className='text-base font-bold italic line-through'>{medici?.price} TK</p> */}
                    </div>
                </div>
            </div>
        </div>
